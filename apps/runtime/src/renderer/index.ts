...
export type { RendererAdapter, RendererConfig, RendererState, RenderSurface } from "./adapter.js";

export type { CapabilityComparison, CapabilityDiff, RendererCapabilities } from "./capabilities.js";
...
export { executeHotSwap, HotSwapCapabilityError, HotSwapError } from "./hot_swap.js";

export type { RegistrationMeta } from "./registry.js";
export { DuplicateRendererError, RendererNotFoundError, RendererRegistry } from "./registry.js";
...
export { SwitchSameRendererError, SwitchTimeoutError, switchRenderer } from "./switch.js";
export type {
  SwitchTransaction,
