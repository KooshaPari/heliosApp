...
import { AuditStorage } from '../../../src/audit/sink';
import fs from 'fs';
...
describe('Storage Chaos Tests', () => {
  ...
  it('should document acceptable loss during hard crash', async () => {
    ...
    console.log(`Acceptable: Events in ring buffer at time of crash (up to ${sink.getMetrics().bufferHighWaterMark || 100} events)`);
