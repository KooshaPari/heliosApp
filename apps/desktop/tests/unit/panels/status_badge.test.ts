...
describe('StatusBadge', () => {
  ...
  it('should apply correct colors from scheme', () => {
    ...
    const badgeElement = container.querySelector('.status-badge[data-state="running"]') as HTMLElement;
  ...
  it('should include ARIA labels for accessibility', () => {
    const states = ['idle', 'running', 'blocked', 'error', 'shared', 'provisioning', 'cleaning', 'closed', 'orphaned'];
