...
export const FileContextPanel: Component<FileContextPanelProps> = (props) => {
  return (
    <Show when={props.isVisible && props.files.length > 0}>
      <div style={{
        width: "250px", "border-left": "1px solid #313244",
        "background-color": "#181825", padding: "12px", "overflow-y": "auto",
      }}>
        <h3 style={{ color: "#a6adc8", "font-size": "12px", "text-transform": "uppercase",
        ...
        <For each={props.files}>
          {(file) => (
            <div style={{
              ...
              "background-color": "#1e1e2e", "font-size": "12px",
            }}>
              <div style={{ color: file.type === "write" ? "#f9e2af" : "#89b4fa", display: "flex",
