  ...
  return (
    <Show when={props.isOpen}>
      <div style={{
        ...
        <div style={{
          "background-color": "#1e1e2e", "border-radius": "16px", padding: "32px",
          "max-width": "480px", width: "100%", border: "1px solid #313244",
        }}>
          <Show when={step() === 0}>
            <h2 style={{ color: "#cdd6f4", "margin-bottom": "12px" }}>Welcome to Helios</h2>
            <p style={{ color: "#a6adc8", "line-height": "1.6", "margin-bottom": "24px" }}>
              An agent-first desktop IDE. Chat with AI to write code, run commands, and build projects.
            </p>
            <button onClick={() => setStep(1)} style={{
              background: "#89b4fa", border: "none", color: "#1e1e2e", "border-radius": "8px",
          ...
          <Show when={step() === 1}>
            ...
            <input
              ...
              placeholder="sk-ant-..."
              style={{
                width: "100%", padding: "10px 12px", "background-color": "#313244",
            ...
            <div style={{ display: "flex", gap: "8px", "justify-content": "flex-end" }}>
              ...
              <button onClick={() => props.onComplete(apiKey())} style={{
                background: "#89b4fa", border: "none", color: "#1e1e2e", "border-radius": "8px",
