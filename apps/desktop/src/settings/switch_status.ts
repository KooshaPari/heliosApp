...
export type SwitchPhase = 'started' | 'initializing' | 'swapping' | 'committing' | 'committed' | 'rolled_back' | 'failed';
...
export class SwitchStatus {
  ...
  private createStatusElement(): HTMLElement {
    ...
    if (this.props.phase === 'started' || this.props.phase === 'initializing' || this.props.phase === 'swapping' || this.props.phase === 'committing') {
    ...
    if (this.props.phase === 'started' || this.props.phase === 'initializing' || this.props.phase === 'swapping' || this.props.phase === 'committing') {
      ...
      const maxDuration = this.props.phase === 'swapping' ? 3000 : 8000; // 3s for hot-swap, 8s for restart
