...
- [x] T032 Implement protocol boundary adapter and dispatch selection in `apps/runtime/src/protocol/boundary_adapter.ts` and integrate with `apps/runtime/src/integrations/exec.ts`
