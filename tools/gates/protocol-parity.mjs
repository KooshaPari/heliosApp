...
const matrix = readJson(
  resolve(
    root,
    "agileplus/001-colab-agent-terminal-control-plane/contracts/protocol-parity-matrix.json"
  )
);
const contract = readJson(
  resolve(
    root,
    "agileplus/001-colab-agent-terminal-control-plane/contracts/orchestration-envelope.schema.json"
  )
);
